...
import { findContactById, findGroupById } from "../../services/contactService";
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
        try {
            ...
            const {data : contactData} = await findContactById(contactId);
            const {data : groupData} = await findGroupById(contactData.group);
